...
export const copy = {
  zh: {
    ...
    noAgents: "还没有智能体。",
    addAgent: "添加智能体",
    noMessages: "先输入一个产品需求，Agent 会从澄清问题开始，最终生成三套产品/UI实施报告。",
    deleteAgent: "删除智能体",
    editAgent: "编辑智能体",
    agentEnabled: "已启用",
    agentDisabled: "已停用",
  ...
  en: {
    ...
    addAgent: "Add agent",
    noMessages: "Enter a product requirement first. Agents will clarify it, then produce three product/UI implementation reports.",
