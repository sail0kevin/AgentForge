...
1. [LangGraph 工作流架构](langgraph-workflow-architecture - LangGraph工作流架构.md)
2. [多 Agent 交叉评审工作流](multi-agent-cross-review-workflow - 多智能体交叉评审工作流.md)
3. [LangChain 集成设计](langchain-integration-design - LangChain集成设计.md)
4. [Web UI/UX 知识工具设计](web-ui-ux-knowledge-tool-design - Web界面知识工具设计.md)
5. [来源与许可说明](references - 设计参考与许可说明.md)
