...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    "dist-electron/**",
    "local-only/**",
    // PostgreSQL Prisma client is generated by db:generate and is not application source.
    "prisma/generated/**",
    "next-env.d.ts",
    // Historical one-off scripts are preserved as records, not active source code.
    "archive/**",
    // P4a smoke-test run outputs are generated by Claude, not application source.
    "artifacts/**",
  ]),
]);
